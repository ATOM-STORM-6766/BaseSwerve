...
public class Swerve extends SubsystemBase {
     ...
     * 
     * Initializes the gyro, swerve modules, odometry & odometry thread, and auto
     * builder.
     */
    public Swerve() {
        ...
        /**
         * Initializes an array of SwerveModule objects with their respective names,
         * IDs, and constants.
         * This array represents the robot's four swerve modules.
         * If there are multiple sets of modules, swap out the constants for the module
         * in use.
         */
        ...
        /**
         * Configures the odometry, which requires the kinematics, gyro reading, and
         * module positions.
     ...
     *
     * @param translation A Translation2d representing the desired movement (m/s) in
    ...
    public ChassisSpeeds fieldRelativeSpeeds(Translation2d translation, double angularVel) {
        ChassisSpeeds speeds = ChassisSpeeds.fromFieldRelativeSpeeds(translation.getX(), translation.getY(), angularVel,
                getYaw());
        return ChassisSpeeds.discretize(speeds, Constants.LOOP_TIME_SEC);
    }

    /**
     * Set the ChassisSpeeds to drive the robot. Use predefined methods such as
     * {@code}robotSpeeds{@code} or create a new ChassisSpeeds object.
     * 
     * @param chassisSpeeds The ChassisSpeeds to generate states for.
     * @param isOpenLoop    Whether the ChassisSpeeds is open loop (Tele-Op
     *                      driving), or closed loop (Autonomous driving).
     */
    ...
    /**
     * Set the ChassisSpeeds to drive the robot. Defaults to closed loop.
     * <p>
     * Used by AutoBuilder.
     * 
     * @param chassisSpeeds The ChassisSpeeds to generate states for.
    ...
    public Rotation2d getYaw() {
        return (SwerveConstants.GYRO_INVERT) ? Rotation2d.fromDegrees(-m_pigeon2.getAngle()) // m_pigeon2.getRotation2d().minus(Rotation2d.fromDegrees(360))
    ...
    public void configGyro() {
        DeviceConfig.configurePigeon2("Swerve Pigeon", m_pigeon2, DeviceConfig.swervePigeonConfig(),
