...
/**
 * A swerve module, which consists of an angle motor, a drive motor, and an
 * angle encoder.
 * <p>
 * Provides methods to get and set all parts of the module, such as the speed
 * and angle.
 */
public class SwerveModule {
     ...
     * <p>
     * Use {@code}NeutralModeValue.Brake{@code} or
     * {@code}NeutralModeValue.Coast{@code}
     * 
     ...
     * @param isOpenLoop   Whether the desired state is open loop (Tele-Op driving),
     *                     or closed loop (Autonomous driving).
     */
    ...
    /**
     * Sets the speed of the swerve module based on the desired state's speed and
     * whether it is in open loop or closed loop control.
     *
     * @param desiredState The desired state of the swerve module.
     * @param isOpenLoop   Whether to drive in an open loop (Tele-Op) or closed loop
     *                     (Autonomous) state.
     */
    ...
    private void setAngle(SwerveModuleState desiredState) {
        /*
         * Prevent rotating module if speed is less then 1%. Prevents jittering when not
         * moving.
         */
    ...
    private void configAngleEncoder() {
        DeviceConfig.configureSwerveEncoder(m_modLocation + " Angle Encoder", m_angleEncoder,
                DeviceConfig.swerveEncoderConfig(m_angleOffset), Constants.LOOP_TIME_HZ);
    }
    ...
    private void configSteerMotor() {
        DeviceConfig.configureTalonFX(m_modLocation + " Steer Motor", m_steerMotor,
                DeviceConfig.steerFXConfig(m_angleEncoder.getDeviceID()), Constants.LOOP_TIME_HZ);
    }
     ...
     * 
     * @return The state of the swerve module, including the velocity (m/s) and
     *         angle.
     */
     ...
     * @param refresh Whether to refresh the readings from the motors.
     * 
     * @return The position of the swerve module, consisting of the distance
     *         traveled in meters and the angle.
     */
    public SwerveModulePosition getPosition(boolean refresh) {
        ...
        double distance = Conversions.falconRotationsToMechanismMeters(driveRotations,
                SwerveConstants.MODULE_TYPE.wheelCircumference, 1);
